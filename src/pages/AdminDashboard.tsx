    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <header className="bg-white border-b shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link to="/">
              <Button variant="ghost" size="sm"><ArrowLeft size={14} className="mr-1" /> Home</Button>
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((mod) => {
            const count = stats[mod.key as keyof ModuleStats];
            return (
                ...
                <Card className="hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer group border-border/50">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${mod.color} flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform`}>
                        <mod.icon size={22} />
                      </div>
                  ...
                  <CardContent className="pt-0">
                    <Button variant="ghost" size="sm" className="text-xs px-0 text-orange-600 hover:text-orange-700">
                      Manage →
                    </Button>
                  </CardContent>
                </Card>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/booking/dashboard">
              <Button variant="outline" size="sm">📋 Hall Booking System</Button>
            </Link>
            <Link to="/admin/members">
              <Button variant="outline" size="sm">➕ Add New Member</Button>
            </Link>
